...
public class ServidorUno extends Conexion { //Se hereda de conexión para hacer uso de los sockets
	private Semaphore sem1;
	private ArrayList<String[]> datos;
	
    public ServidorUno() throws IOException {
		super("servidor");
		//Creamos un semáforo
		sem1 = new Semaphore(1);
		//Creamos un ArrayList de datos tipo String
    ...
    public void startServer() {
        ...
        System.out.println("SERVIDOR UNO REPLICA ON..."); 
		try {
			...
			while(true){
				...
				//llamamos al método que carga los datos del array
				leerResultados();
