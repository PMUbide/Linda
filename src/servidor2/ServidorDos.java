...
public class ServidorDos extends Conexion { //Se hereda de conexión para hacer uso de los sockets
	
	private Semaphore sem1;
	private ArrayList<String[]> datos;
	
    public ServidorDos() throws IOException {
		super("servidor");
		//Creamos un semáforo
    ...
    public void startServer() {
        ...
        System.out.println("SERVIDOR DOS ON...");
		try {
	...
	public void leerResultados() {
		String ruta = "files/servidor2.txt";
